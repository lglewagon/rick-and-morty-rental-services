...
Character.create(name: 'Morty test', description: 'prout', category: 'Morty', photo_url: 'image', availability: true)
Character.create(name: 'Morty test 0', description: 'prout', category: 'Morty', photo_url: 'image', availability: true)
